      ...
      <header>
        <nav class="flex justify-between w-full items-center pe-4">
          <router-link to="/teachers"
            class="logo ms-10 text-center text-2xl p-3 block text-blue-900 font-bold">O'qituvchilar</router-link>
        </nav>
      </header>
    </div>
      ...
      <div class="relative bg-white rounded-[20px] shadow-lg w-[1000px] h-[650px]">
        ...
        <form @submit.prevent="addTeacher">
          <div class="grid gap-4 ml-20 m-4 sm:grid-cols-2 mt-5">
            <div class="mb-3">
              <label for="first_name" class="block mb-2 text-xl font-medium text-gray-500">Ism <span
                  class="">*</span></label>
              <input v-model="teachers.first_name" type="first_name" name="first_name" id="first_name"
                class="border border-gray-400 text-[#A098AE] text-sm rounded-xl block w-[350px] h-[40px] p-2.5"
                placeholder="Ismini kiriting" required="" />
            </div>
            <div>
              <label for="last_name" class="block mb-2 text-xl font-medium text-gray-500">Familiyasi <span
                  class="">*</span></label>
              <input v-model="teachers.last_name" type="last_name" name="last_name" id="last_name"
                class="border border-gray-400 text-[#A098AE] text-sm rounded-xl block w-[350px] h-[40px] p-2.5"
                placeholder="Familiyasini kiriting" required="" />
            </div>
            <div class="mb-3">
              <label for="login" class="block mb-2 text-xl font-medium text-gray-500">Login <span
                  class="">*</span></label>
              <input v-model="teachers.login" type="username" name="login" id="login"
                class="border border-gray-400 text-[#A098AE] text-sm rounded-xl block w-[350px] h-[40px] p-2.5"
                placeholder="Login kiriting" required="" />
            </div>
            <div>
              <label for="password" class="block mb-2 text-xl font-medium text-gray-500">Parol <span
                  class="">*</span></label>
              <input v-model="teachers.password" type="password" name="password" id="password"
                class="border border-gray-400 text-[#A098AE] text-sm rounded-xl block w-[350px] h-[40px] p-2.5"
                placeholder="******************" required="" />
            </div>
            <div class="mb-3">
              <label for="info" class="block mb-2 text-xl font-medium text-gray-500">Ma`lumot <span
                  class="">*</span></label>
              <textarea v-model="teachers.info" name="info" id="info"
            ...
            <div>
              <label for="image" class="block mb-2 text-xl font-medium text-gray-500">Rasm <span class="">*</span></label>
            ...
            <div class="mb-3">
              <label for="birthday" class="block mb-2 text-xl font-medium text-gray-500">Tug'ilgan sanasi <span
                  class="">*</span></label>
              <input v-model="teachers.birthday" type="text" name="birthday" id="birthday"
                class="border border-gray-400 text-[#A098AE] text-sm rounded-xl block w-[350px] h-[40px] p-2.5"
                placeholder="24 February 1997" required="" />
            </div>

            <div>
              <label for="group" class="block mb-2 text-xl font-medium text-gray-500">Guruhni tanlang <span
                  class="">*</span></label>
              <input v-model="teachers.group" type="text" name="group" id="group"
                class="border border-gray-400 text-[#A098AE] text-sm rounded-xl block w-[350px] h-[40px] p-2.5"
                placeholder="Guruhni tanlang" required="" />
            </div>
          </div>
          <div class="mt-8 ">
    ...
    <div class="flex flex-wrap gap-4 justify-beetwen items-center">
      <div v-for="(el, i) in store.LIST" :key="i" class="w-[250px] h-[350px] shadow-lg bg-[#FFFFFF] rounded-[20px]">
        <div class="text-end pr-5">
          <a href="#"
            class="text-gray-500 inline-block text-2xl rounded-full px-1 mt-2  hover:bg-indigo-800 hover:text-white">
            <i class="bx bx-dots-horizontal-rounded"></i>
          </a>
        </div>
        <div class="flex justify-center items-center">
          <img class="w-[120px] h-[120px] object-cover justify-center items-center rounded-full"
